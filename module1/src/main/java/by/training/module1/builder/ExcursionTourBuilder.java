...
public class ExcursionTourBuilder implements Builder {
    ...
    public ExcursionTour build(Map<String, String> tourBuild) {
        ...
        LOGGER.info("Building Excursion tour...");
        TourType tourType = TourType.valueOf(tourBuild.get("tourType").toUpperCase());
        ...
        ExcursionTour tour = new ExcursionTour(tourType, tourDuration, transport, food, freeExcursion, excursionType, price);
